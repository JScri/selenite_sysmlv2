...
%
%  v4.4: Full power chain from MOLEI_THERMAL v1.3:
%    - MOLE-I tether draw: 1934W (load 1785 + DC-DC 99 + batt 50)
%    - Fleet power uses tether draw, not load power
%    - Substation WEB heater: 80W -> 10.5W (bottom-up audit)
%    - Substation total overhead: 130W -> 95.5W (audited components)
%    - Substation LWRHU: 1x -> 3x (33hr survival at 253K)
%    - 108-conductor harness (was 49), VEX heater 1000V direct
%    - Power architecture: 1000 VDC end-to-end, no LV segment
%    - DC-DC conversion losses explicit in fleet power
...
fprintf('================================================================\n');
fprintf('  SELENITE v4.4 - Full Power Chain Model\n');
fprintf('  6-Wheel MOLE-I | Hybrid Power | Bilateral Fishbone\n');
fprintf('  Tether 1934W (load 1785 + DC-DC 99 + batt 50)\n');
fprintf('  Substation 95.5W (was 130W) | 3x LWRHU (was 1x)\n');
fprintf('  Ref: MOLEI_THERMAL v1.3\n');
fprintf('================================================================\n\n');
...
xticks(x); xticklabels(ph.lab); title('Fleet Scaling (v4.4)'); grid on; set(gca,'FontSize',11);
...
fprintf('\n================================================================\n');
fprintf('  v4.4 SUMMARY (full power chain, ref: MOLEI_THERMAL v1.3)\n');
fprintf('================================================================\n');
