...
%
%  v4: Corrected eclipse model, CAP power, 6-wheel cascade, EOL derating
...
fprintf('================================================================\n');
fprintf('  SELENITE v4 - Corrected Eclipse + CAP\n');
...
mi.pwr.drive=300; mi.pwr.drill=200; mi.pwr.minivex=1200; mi.pwr.web=57;
mi.pwr.comms=20; mi.pwr.gbx_htr=30; mi.pwr.drill_htr=15; mi.pwr.recept=5; mi.pwr.vex_stby=25;
...
xticks(x); xticklabels(ph.lab); title('Fleet Scaling (v4)'); grid on; set(gca,'FontSize',11);
...
pl={sprintf('Drive %dW',mi.pwr.drive),sprintf('Drill %dW',mi.pwr.drill),...
    ...
    sprintf('VEX stby %dW',mi.pwr.vex_stby)};
pie(pv); legend(pl,'Location','eastoutside','FontSize',9);
title(sprintf('MOLE-I: %dW op / %dW ka (6-wheel)',mi.pwr_op,mi.pwr_ka));
