...
(14 Sep 2026): `Gates.sysml` and `Parameters.sysml` skeletons exist; Wave 3
proper (the gate catalogue) is the next session, with Decision Framework v4
and Strategy v3.1 now in `docs/`. Previous state: **Wave 2 complete**
