...
| W2-N8 | `SEL_FINAL_REPORT_v4` Fig. 34 P14 card: "5 mass drivers operational … Total YBCO: ~303 t lifetime" — pre-ECN-020 (523 t, 8 tracks). The report is only partially ECN-020-propagated (F9). | report |
