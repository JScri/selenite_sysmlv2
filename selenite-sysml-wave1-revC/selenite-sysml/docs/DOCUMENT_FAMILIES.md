...
| W2-N15 | **Missing element found:** ISRU LH₂/LOX Earth-return capsule (SEL-TRANSPORT-001C, "LH₂ transport v4"), SPA→Earth batch payload P5–P8, superseded by mass drivers at P9 (Fig. 54; value chain v14.1 "Starship return P7–P9"). Absent from `ARCHITECTURE_BASELINE.md` §5. Added to the model as `EarthReturnCapsuleLink`. Leaves SPA→Earth P9–P11 with no named link (MD-4 is P11) — open. | `Transport.sysml` |
