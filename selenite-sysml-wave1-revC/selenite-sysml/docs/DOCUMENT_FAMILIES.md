...
| W2-N18 | PSR MOLE-I capacity: fleet v9 §4.1 and Strategy v3.1 §4.4 "~310 MOLE-I positions (~8.5 km² usable floor, 62 substations)"; Strategy v3.1 §4.3 "62 junctions (620 MOLE-I max)"; final report Fig. 12 (VISUALIZE v3.3) "124 nodes (620 MOLE-I) in 33.2 km² floor"; Fig. 11 "~17.5 km² feasible". One document (Strategy) carries both 310 and 620. This cap drives the Mk III transition gate (DG-11.6). `ProgrammeParameters.psrMoleICapacityUnits` left unbound; the `psr_layout.py` port of VISUALIZE v3.3 (66 golden rows) is the arbiter. | `Parameters.sysml` |
