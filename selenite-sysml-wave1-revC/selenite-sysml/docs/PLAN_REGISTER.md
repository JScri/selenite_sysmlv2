...
| shackletonHub.powerZone.spaMsr.introducedIn | SpaThoriumMSR | unbound | DG-10.5 (P10, Y50) | None | Y105 (P12) - ECON spa_msr_count first non-zero (the economics' assumption, F5) | def unbound -> gate; vector P12 vs def None |
...
| W3-R30 | DG-13.6: listed under P13 but its year Y115 is P12 | Gates.sysml / Phases.sysml |
...
| W3-R42 | DG-POST.2: derivable but unevaluated - tier2ResourceTonnes unbound (Wave 5) | Gates.sysml / Parameters.sysml |
| W3-R43 | shackletonHub.isru.selfSufficientFrom: definition P4, vector says P3 - VERIFY ph.isru >= ph.dT | ProgrammeConfiguration.sysml / selenite-compute |
| W3-R44 | shackletonHub.industrialZone.emCatcher.introducedIn: definition P11 but bound to DG-9.6 (P9/P10, Y43) | ProgrammeConfiguration.sysml |
| W3-R45 | shackletonHub.industrialZone.emCatcher.operationalFrom: definition P11 but bound to DG-9.6 (P9/P10, Y43) | ProgrammeConfiguration.sysml |
| W3-R46 | shackletonHub.powerZone.spaMsr.introducedIn: definition unbound, vector says Y105 - ECON spa_msr_count first non-zero (the economics' assumption, F5) | ProgrammeConfiguration.sysml / selenite-compute |
| W3-R47 | shackletonHub.probeMkI.isruFuelledFrom: definition P4, vector says P3 - VERIFY ph.isru >= ph.dP (the P3 units are Earth-fuelled by policy) | ProgrammeConfiguration.sysml / selenite-compute |
| W3-R48 | shackletonHub.probeMkIII.prospectingRoleFrom: definition P13 but bound to DG-14.9 (P14, Y115) | ProgrammeConfiguration.sysml |
| W3-R49 | shackletonHub.probeMkIII.prospectingRoleFrom: definition P13, vector says Y115 - ECON mkiii_active falls to the 300-unit prospecting fleet | ProgrammeConfiguration.sysml / selenite-compute |
| W3-R50 | shackletonHub.skip.introducedIn: definition P4 but bound to DG-2.2 (P2, Y5) | ProgrammeConfiguration.sysml |
| W3-R51 | shackletonHub.dart.pktSiteConfirmationIn: definition P7 but bound to DG-6.3 (P6, Y13) | ProgrammeConfiguration.sysml |
| W3-R52 | shackletonHub.cap.introducedIn: definition P4, vector says P6 - VERIFY ph.p_cap (CAP standby power) = [0.0, 0.0, 0.0, 1.0, 1.0] | ProgrammeConfiguration.sysml / selenite-compute |
