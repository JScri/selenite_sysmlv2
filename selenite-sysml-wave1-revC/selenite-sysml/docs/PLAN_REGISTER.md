...
| DG-10.5 | derivable | P10 | Y50 | P10 | SPA MSR unit #1: FSP fleet dearer than an MSR, with ThCl4 available: Y69 (P11) | later than declared | plan_vectors.fsp_msr_trade: FSP fleet Earth mass for eclipse-critical demand (132-146 kW, 4 units max) exceeds one SPA MSR's Earth mass from Y69 (Ni-201 in-situ vessels); ThCl4 from MD-3 Y43; asteroid loads not eclipse-critical (unbound; with them critical the MSR is forced by Y69); ECON spa_msr_count reaches 1 at Y105 |
...
| DG-11.3 | derivable | P11 | Y70 | P11 | SPA MSR unit #1: FSP fleet dearer than an MSR, with ThCl4 available: Y69 (P11) | consistent | plan_vectors.fsp_msr_trade: FSP fleet Earth mass for eclipse-critical demand (132-146 kW, 4 units max) exceeds one SPA MSR's Earth mass from Y69 (Ni-201 in-situ vessels); ThCl4 from MD-3 Y43; asteroid loads not eclipse-critical (unbound; with them critical the MSR is forced by Y69); ECON spa_msr_count reaches 1 at Y105 |
...
| DG-13.4 | derivable | P13 (alt P12) | Y105 | P12 | SPA MSR unit #1: FSP fleet dearer than an MSR, with ThCl4 available: Y69 (P11) | earlier than declared | plan_vectors.fsp_msr_trade: FSP fleet Earth mass for eclipse-critical demand (132-146 kW, 4 units max) exceeds one SPA MSR's Earth mass from Y69 (Ni-201 in-situ vessels); ThCl4 from MD-3 Y43; asteroid loads not eclipse-critical (unbound; with them critical the MSR is forced by Y69); ECON spa_msr_count reaches 1 at Y105 |
...
| DG-14.4 | derivable | P14 (alt P13) | Y125 | P13 | SPA MSR unit #2: FSP fleet dearer than an MSR, with ThCl4 available: Y69 (P11) | earlier than declared | plan_vectors.fsp_msr_trade: FSP fleet Earth mass for eclipse-critical demand (132-146 kW, 4 units max) exceeds one SPA MSR's Earth mass from Y69 (Ni-201 in-situ vessels); ThCl4 from MD-3 Y43; asteroid loads not eclipse-critical (unbound; with them critical the MSR is forced by Y69); ECON spa_msr_count reaches 2 at Y125 |
...
| DG-14.7 | derivable | P14 | Y140 | P13/P14 | SPA MSR unit #3: FSP fleet dearer than an MSR, with ThCl4 available: Y69 (P11) | earlier than declared | plan_vectors.fsp_msr_trade: FSP fleet Earth mass for eclipse-critical demand (132-146 kW, 4 units max) exceeds one SPA MSR's Earth mass from Y69 (Ni-201 in-situ vessels); ThCl4 from MD-3 Y43; asteroid loads not eclipse-critical (unbound; with them critical the MSR is forced by Y69); ECON spa_msr_count reaches 3 at Y140 |
...
| shackletonHub.powerZone.spaMsr.introducedIn | SpaThoriumMSR | unbound | DG-10.5 (P10, Y50) | Y69 (P11) | Y105 (P12) - ECON spa_msr_count first non-zero (the economics' assumption, F5) | def unbound -> gate; vector P12 vs def None |
...
| W3-R13 | DG-10.5 SPA MSR commissioning - ThCl4 mass-driven from PKT. Enables scaled PRO...: declared Y50 (P10); derived Y69 (P11) - plan_vectors.fsp_msr_trade: FSP fleet Earth mass for eclipse-critical demand (132-146 kW, 4 units max) exceeds one SPA MSR's Earth mass from Y69 (Ni-201 in-situ vessels); ThCl4 from MD-3 Y43; asteroid loads not eclipse-critical (unbound; with them critical the MSR is forced by Y69); ECON spa_msr_count reaches 1 at Y105 | Gates.sysml / econ.py |
...
| W3-R16 | DG-11.5 Conveyor network scales to ~15,000 km: declared - (P11); derived Y103 (P12) - ECON conv_km_needed >= 1.5e+04 (max 1.375e+05; Y200 1.375e+05) | Gates.sysml / econ.py |
| W3-R17 | DG-11.6 PROBE Mk III SEP commissioning + SPA->Earth mass driver for PGM export...: declared Y65 (P11); derived never - ECON molei_needed peak 357 at Y35; with the fleet v9 figure 310 the need exceeds capacity at Y31 (sensitivity only, W2-N18) | Gates.sysml / econ.py |
| W3-R18 | DG-12.1 500,000 t/yr REO -> 40% global displacement (revised from 1,000,000 at...: declared Y80 (P12); derived Y121 (P13) - ECON reo_target >= 5e+05 (max 2.5e+06; Y200 2.5e+06) | Gates.sysml / econ.py |
| W3-R19 | DG-12.1: its criteria split - REO >= 500,000 t/yr -> Y121; supply fraction >= 40% -> Y141 | Gates.sysml / econ.py |
| W3-R20 | DG-12.2 Thorium MSR fleet at ~6,890 x 100 MWe (689 GW) at PKT full-scale: declared Y85 (P12); derived Y173 (P14) - ECON msr_count >= 6,890 (max 8,334; Y200 8,334) | Gates.sysml / econ.py |
| W3-R21 | DG-12.3 PKT->Earth mass driver: scaling toward 783/day at P14+ steady state: declared Y85 (P12); derived Y141 (P14) - ECON canisters_yr / 365 (3.5 t per canister; Y200 1,957/day; ECN-020 corrected the 2.5 Mt/yr cadence to ~1,903/day) | Gates.sysml / econ.py |
| W3-R22 | DG-13.1 1,250,000 t/yr REO - 50% of projected global demand. P13 milestone, no...: declared Y120 (P13); derived Y152 (P14) - ECON reo_target >= 1.25e+06 (max 2.5e+06; Y200 2.5e+06) | Gates.sysml / econ.py |
| W3-R23 | DG-14.1 C-type asteroid targeting decision gate - selects target optimising fo...: declared Y95 (P13/P14); derived Y95 (P12) - derivedYear = parameters.cTypeCaptureYear; declared year Y95 is P12 by the year table | Gates.sysml / Parameters.sysml |
| W3-R24 | DG-14.1: listed under P13 (alt P14) but its year Y95 is P12 | Gates.sysml / Phases.sysml |
| W3-R25 | DG-13.4 SPA MSR #1 commissioned - 50 MWe, ThCl4 fuel from PKT->SPA mass driver...: declared Y105 (P13/P12); derived Y69 (P11) - plan_vectors.fsp_msr_trade: FSP fleet Earth mass for eclipse-critical demand (132-146 kW, 4 units max) exceeds one SPA MSR's Earth mass from Y69 (Ni-201 in-situ vessels); ThCl4 from MD-3 Y43; asteroid loads not eclipse-critical (unbound; with them critical the MSR is forced by Y69); ECON spa_msr_count reaches 1 at Y105 | Gates.sysml / econ.py |
...
| W3-R33 | DG-14.4 SPA MSR #2 commissioned - 100 MWe for S-type Si refinery power.: declared Y125 (P14/P13); derived Y69 (P11) - plan_vectors.fsp_msr_trade: FSP fleet Earth mass for eclipse-critical demand (132-146 kW, 4 units max) exceeds one SPA MSR's Earth mass from Y69 (Ni-201 in-situ vessels); ThCl4 from MD-3 Y43; asteroid loads not eclipse-critical (unbound; with them critical the MSR is forced by Y69); ECON spa_msr_count reaches 2 at Y125 | Gates.sysml / econ.py |
...
| W3-R37 | DG-14.7 SPA MSR #3 commissioned - scaled operations, full asteroid processing...: declared Y140 (P14); derived Y69 (P11) - plan_vectors.fsp_msr_trade: FSP fleet Earth mass for eclipse-critical demand (132-146 kW, 4 units max) exceeds one SPA MSR's Earth mass from Y69 (Ni-201 in-situ vessels); ThCl4 from MD-3 Y43; asteroid loads not eclipse-critical (unbound; with them critical the MSR is forced by Y69); ECON spa_msr_count reaches 3 at Y140 | Gates.sysml / econ.py |
